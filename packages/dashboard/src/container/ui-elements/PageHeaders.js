      ...
      <Main>
        <Row gutter={25}>
          <Col md={24} sm={24} xs={24}>
            <Cards
              title="Basic header"
              caption="The simplest use of Page header"
            >
              <PageHeaderWrapper>
                <PageHeader
                  bgColor="#fff"
          ...
          <Col md={24} sm={24} xs={24}>
            <Cards
              ...
              caption="The simplest use of Breadcrumb header"
            >
              <PageHeaderWrapper>
                <PageHeader
                  bgColor="#fff"
          ...
          <Col md={24} sm={24} xs={24}>
            <Cards
              title="Extra content header"
              caption="The simplest use of Extra content header"
            >
              <PageHeaderWrapper>
                <PageHeader
                  bgColor="#fff"
